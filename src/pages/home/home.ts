  ...
  public reproducir(num){
    switch (num) {
      case num = 1:
        ...
        this.nativeAudio.play('1', () => this.boton1 = true);
      break;
      case num = 2:
        if (this.reproducirLista) {
          this.boton2 = false;
        }  
        this.nativeAudio.play('2', () => this.boton2 = true);      
      break;
      case num = 3:
        if (this.reproducirLista) {
          this.boton3 = false;
        }
        this.nativeAudio.play('3', () => this.boton3 = true);      
      break;
      case num = 4:
        if (this.reproducirLista) {
          this.boton4 = false;
        }
        this.nativeAudio.play('4', () => this.boton4 = true);      
      break;
      case num = 5:
        if (this.reproducirLista) {
          this.boton5 = false;
        }
        this.nativeAudio.play('5', () => this.boton5 = true);      
      break;
      case num = 6:
        if (this.reproducirLista) {
          this.boton6 = false;
        }
        this.nativeAudio.play('6', () => this.boton6 = true);      
      break;
      default:
        break;
    }
